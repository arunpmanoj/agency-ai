...
const Navbar = ({ theme, setTheme }) => {
    ...
    return (
        <motion.div initial={{opacity:0, y:-50}} animate={{ opacity: 1, y: 0 }} transition={{duration: 0.6, ease: 'easeOut'}} className="flex justify-between items-center px-4 
        ...
        font-medium bg-white/50 dark:bg-gray-900/70">
            ...
            <img src={assets.close_iconƒ} alt="" className='w-5 absolute right-4 top-4 sm:hidden'
            ...
            <a href="#contact-us"
                className="text-sm max-sm:hidden flex items-center gap-2 bg-[var(--color-primary)] text-white px-6 py-2 
